package com.eran.apptemplate.exception.crash;
...
import com.eran.apptemplate.utils.LogUtils;
import com.eran.apptemplate.utils.ManagerActivity;
import com.eran.apptemplate.utils.StrUtils;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
               /* HashMap<String,String> params=new HashMap<String,String>();
                ...
                if (result.equals("1")){
                    LogUtils.d(TAG,"崩溃日志投递成功...");
                }else {
                    LogUtils.d(TAG,"崩溃日志投递失败...");
                }*/
            }
        }).start();
    }
