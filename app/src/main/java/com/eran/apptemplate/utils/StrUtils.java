...
import com.eran.apptemplate.EranApp;
...
public class StrUtils {
    ...
    public static String getIpCountry() {
        ...
        try {
            TelephonyManager mTelephonyManager = (TelephonyManager) EranApp
    ...
    public static String getIpBaseStation() {
        TelephonyManager telMgr = (TelephonyManager) EranApp
                .getInstance().getSystemService(Context.TELEPHONY_SERVICE);
        int cid = 0;
        int lac = 0;
        try {
    ...
    public static String getAndroidId() {
        ...
        return Settings.Secure.getString(EranApp.getInstance()
    ...
    public static int getIpAddress() {
        int ipAddress = 0;
        WifiManager wifiManager = (WifiManager) EranApp
    ...
    public static int getAPNType(Context context){
        ...
        if(nType==ConnectivityManager.TYPE_MOBILE){
            LogUtils.e("networkInfo.getExtraInfo()", "networkInfo.getExtraInfo() is "+networkInfo.getExtraInfo());
